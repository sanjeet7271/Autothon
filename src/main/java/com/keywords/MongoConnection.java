...
public class MongoConnection {
	...
	public void ConnectToDataBase() {
		MongoClientURI uri = new MongoClientURI(
				"mongodb://<userID>:<password>@shop-api-shard-00-00-ndpvc.mongodb.net:27017,shop-api-shard-00-01-ndpvc.mongodb.net:27017,shop-api-shard-00-02-ndpvc.mongodb.net:27017/test?ssl=true&replicaSet=Shop-API-shard-0&authSource=admin&retryWrites=true&w=majority");
